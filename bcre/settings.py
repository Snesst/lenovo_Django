...
SECRET_KEY = 'django-insecure-@5)x4o5g!u6i+cjipig5rf=0u1t^nog_ga$&j32$2z_%vcr_wh'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'templates')], # the content inside this [] is typed in by user
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
